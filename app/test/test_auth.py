...
def register_user_missing_data(self):
    return self.client.post(
        '/user/',
        data=json.dumps(dict(
            email='prova',
...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_registration_with_missing_data(self):
        ...
        with self.client:
            response = register_user_missing_data(self)
            data = json.loads(response.data.decode())
    ...
    def test_unathorised_access(self):
        #TODO when there are protected resources
        return

    def test_unauthorised_admin(self):
        #TODO when there are protected resources
        return
        

    def test_authorised_admin(self):
        resp_register = register_user(self)
        response = login_user(self)
        ...
        db.session.add(user)
        db.session.commit()
        data_login = json.loads(response.data.decode())
        auth_token = data_login['Authorization']
